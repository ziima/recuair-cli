...
class MainTest(TestCase):
    ...
    def test_start(self):
        ...
        self.assertEqual(post_request_mock.mock_calls,
                         [call(Comparison(httpx.AsyncClient), 'example', {'mode': 'auto'})])
    ...
    def test_stop(self):
        ...
        self.assertEqual(post_request_mock.mock_calls,
                         [call(Comparison(httpx.AsyncClient), 'example', {'mode': 'off'})])
    ...
    def test_holiday(self):
        ...
        self.assertEqual(post_request_mock.mock_calls,
                         [call(Comparison(httpx.AsyncClient), 'example', {'mode': 'holiday'})])
    ...
    def test_bypass(self):
        ...
        self.assertEqual(post_request_mock.mock_calls,
                         [call(Comparison(httpx.AsyncClient), 'example', {'mode': 'bypass'})])
